...
<#
    ...
    --------------------------------------------------------------------------------
     ...
     Generated on:       11/27/2020 12:57 PM
     Generated by:       hrbnkh
    --------------------------------------------------------------------------------
    .DESCRIPTION
...
"@ | Out-Null
	...
	$Search_Click={
		...
		$textboxRunLog.Text+=$listview1.Items.ToString()	
	}
	...
	$Form_Cleanup_FormClosed=
	{
		...
		try
		{
			$Search.remove_Click($Search_Click)
	...
	$Search.add_Click($Search_Click)
	#
	# textboxSearch
	#
	$textboxSearch.Location = '3, 50'
	$textboxSearch.Name = 'textboxSearch'
	$textboxSearch.Size = '425, 20'
	...
	$listview1.Location = '3, 75'
	$listview1.Name = 'listview1'
	$listview1.Size = '568, 232'
